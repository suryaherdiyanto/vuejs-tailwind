<template>
    <button class="rounded-md border-2 font-medium cursor-pointer text-white transition-colors focus:outline-none" :class="customClasses" :type="type">{{ text }}</button>
</template>
